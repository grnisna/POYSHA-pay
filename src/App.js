...
import PrivecyPolicy from "./components/SharedCompo/Footer/PrivacyPolicy";
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/TermsConditions" element={<PrivecyPolicy />}></Route>
        ...
        >
          ...
          <Route
            ...
            element={<ViewAllTransaction></ViewAllTransaction>}
          ></Route>
