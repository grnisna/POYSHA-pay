        ...
        <div>
            ...
            <div className='px-5 py-2'>
                <div tabindex="1" className="collapse collapse-plus border border-base-300 bg-base-100 rounded-box">
                    <div className="collapse-title text-xl text-black  font-medium bg-info hover:bg-primary">
                ...
                <div tabindex="6" className="collapse collapse-plus border border-base-300 bg-base-100 rounded-box">
                    <div className="collapse-title text-xl text-black  font-medium bg-info hover:bg-primary">
                ...
                <div tabindex="7" className="collapse collapse-plus border border-base-300 bg-base-100 rounded-box">
                    <div className="collapse-title text-xl text-black  font-medium bg-info hover:bg-primary">
            ...
            {/* <div>
                {
                    questions.map(question => <div
                        ...
                        tabindex="1" className="collapse collapse-plus border border-base-100 bg-base-100 rounded-box"
                    >
