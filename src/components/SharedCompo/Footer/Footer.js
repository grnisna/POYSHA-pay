        ...
        <footer className="footer px-20 py-4 border-t  border-base-300">
          ...
          <div className="md:place-self-center md:justify-self-end">
            <div className="grid grid-flow-col gap-4 mx-auto justify-between items-center">
              <a
                className="text-2xl bg-blue-500 text-white rounded-full p-2 hover:bg-white hover:text-orange-500"
          ...
          <div>
            ...
            <div className="form-control  w-60">
              <label className="label">
                <span className="">
                  Enter your email address hear and get every update of the
                  features via Email.{" "}
                </span>
              </label>
              <div className="relative">
                <input
                  ...
                  className="input input-bordered rounded-lg w-full pr-16"
                />
