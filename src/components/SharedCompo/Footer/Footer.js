      ...
      <div className="text-primary bg-secondary">
        ...
        <footer className="footer  py-10 lg:px-20 mx-auto text-white font-normal">
          <div className=" mx-auto content-footer ">
            <span className="text-xl uppercase lg:pl-10 font-medium">
              Services
            </span>
            <a href="/" className="link link-hover lg:pl-10">
              Branding
            </a>
            <a href="/" className="link link-hover lg:pl-10">
              Design
          ...
          <div className="mx-auto content-footer">
            ...
            <Link to="/TermsConditions" className="link link-hover lg:pl-10">
              Terms & Conditions
            </Link>
            <Link to="/PrivecyPolicy" className="link link-hover lg:pl-10">
              Privacy policy
            </Link>
            <a href="/" className="link link-hover lg:pl-10">
              Cookie policy
          ...
          <div className="w-full ">
            <div className="grid justify-start m-auto ">
              ...
              <span className="w-48 mx-auto text-justify mb-3">
                To make your life easier Download Nagad app and <br />
                access all our services from a single touch point.
              </span>
              <div className="lg:flex lg:gap-4 gap-2 mb-2 mx-auto">
                <button className="btn btn-sm  rounded-full bg-black">
                  <FaGooglePlay className=" text-green-400" /> Google Play
                </button>
                <button className="btn btn-sm  rounded-full bg-black">
                  <BsApple className=" text-grey-400" /> Apple Store
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="bg-primary text-white text-sm">
          <p className="text-center py-4">
            <p>
              All Rights Received || Copyright &copy; {getYear()} - Team Cyber-6{" "}
            </p>
          </p>
        </div>
